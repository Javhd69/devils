...
\033[0;95m╰═══════════════════════════════════╯
\033[1;94m⊱══════════════⊱═⊰NOTE⊱═⊰══════════════⊰
\033[1;91mWARNING :\033[1;93mLOGIN MENGGUNAKAN AKUN BARU
"""
...
os.system("clear")
jalan('\033[1;94mJANGAN LUPA TIDUR ANJING NANTI MATI')
jalan('\033[1;94mKALAU MALING JANGAN BANYAK-BANYAK MALINGLAH SECUKUPNYA')
jalan('\033[1;47m                \033[1;31mUSER-JAV                  \033[1;0m     ') 
jalan('⊱⊹⊰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⊱⊹⊰') 
jalan('\033[1;91m      \033[1;91m MASUKAN SANDI SCRIPT ANJING \033[1;0m     ') 
jalan('⊱⊹⊰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⊱⊹⊰') 
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username  #DEV User-JAV
            loop = 'false'
        else:
...
def pilih_login():
	...
	if peak =="":
		...
		os.system('xdg-open https://github.com/Javhd69')
		login()
	elif unikers =="0":
		jalan('Token Removed')
...
def login1():
	...
	try:
		...
		print logo
		jalan("\033[1;96m⊱⋕⊰══════════════════════════════════════⊱⋕⊰") 
		jalan('\033[1;96m[✾]\x1b[1;91mLOGIN MENGGUNAKAN AKUN BARU ANJING\x1b[1;96m[✾]' )
